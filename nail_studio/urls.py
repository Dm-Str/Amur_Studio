...
urlpatterns = [
    ...
    path('lk_user/', lk_views.get_bonuses, name='get_bonuses'),
    path('lk_user/', lk_views.my_reviews, name='my_reviews'),
    path('lk_user/', lk_views.get_notifications, name='get_notifications'),
    ...
    path('enroll/<int:course_id>/', lk_views.enroll_course, name='enroll_course'),
